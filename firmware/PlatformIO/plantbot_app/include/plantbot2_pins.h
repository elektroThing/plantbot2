...
#define BATTERY_LOW_VOLTAGE    3.5   // Low battery warning threshold
#define BATTERY_CRITICAL_VOLTAGE 3.2 // Critical battery - 24hr sleep
#define BATTERY_UVLO_VOLTAGE   3.0   // Under voltage lockout - no WiFi
